...
function rap_scene()
{
  ...
  Text.set_text("Tux: Hello Penny");
  Text.fade_in(1);
  wait(2.5);
  Text.fade_out(1);
  wait(1);
  play_sound("speech/penny_runt_01.ogg"); // 1.2 seconds
  Text.set_text("Penny: Hey Tux");
  Text.fade_in(0.5);
  wait(1);
  Text.fade_out(0.5);
  wait(0.5);
  play_sound("speech/tux_murp_01.ogg"); // 1.5 seconds
  Text.set_text("Tux: Check out my dance moves.");
  Text.fade_in(0.5);
  wait(1);
  Text.fade_out(0.5);
  wait(0.5);
  ...
  Text.set_text("Tux: Oww... my head...");
  Text.fade_in(1);
  wait(1.9);
  Tux.activate();
  Text.fade_out(0.3);
  wait(0.5);
  Text.set_text("Tux: Wait!"); // t=2.4
  Text.fade_in(0.5);
  wait(1);
  Text.fade_out(0.5);
  wait(0.5);
  Text.set_text("Tux: Penny!"); // t=3.9
  Text.fade_in(0.5);
  wait(1);
  Text.fade_out(0.5);
  wait(0.5);
  Text.set_text("Tux: Where are you, Penny?!"); // t=4.4
  Text.fade_in(0.5);
  wait(2);
  Text.fade_out(0.5);
  wait(0.5);
  Text.set_text("Tux: Oh no..."); // t=6.9
  Text.fade_in(0.5);
  wait(1);
  Text.fade_out(0.5);
  wait(0.5);
  Text.set_text("Tux: Don't worry, Penny, I'll rescue you!"); // t=8.4
  Text.fade_in(0.5);
  wait(2);
  Text.fade_out(0.5);
  wait(0.5);
