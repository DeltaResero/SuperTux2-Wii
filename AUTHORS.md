# The SuperTux (Milestone 2) Hall of Fame

This file honors everyone who made this game possible, from the original
...
* **Report bugs or suggest features:**
  * [Issue Tracker](https://github.com/DeltaResero/SuperTux2-Wii/issues)
<!-- -->
* **For information on the original game:**
  * [SuperTux.org](https://www.supertux.org)
<!-- -->
* **The upstream source code is at:**
  * [SuperTux on GitHub](https://github.com/SuperTux/supertux)
<!-- -->
* **The original Milestone 2 (v0.5.1) source code is archived at:**
  * [SuperTux v0.5.1](https://github.com/SuperTux/supertux/tree/v0.5.1)

<br>

If you have contributed to this project and your name is missing, please open
an Issue or Pull Request on GitHub to let us know! Thank you for caring enough
for our project to even read this file to the end :)

\- The SuperTux 2 Wii Team
