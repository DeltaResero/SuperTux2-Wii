// src/lib/simplesquirrel/include/simplesquirrel/function.hpp
    ...
    */
    ...
    public:
        ...
        */
        ...
        /**
        * @brief Returns the minimum and maximum number of parameters accepted by the function as a pair
